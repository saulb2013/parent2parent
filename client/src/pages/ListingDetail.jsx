        ...
        <div>
          ...
          {!isOwnListing && (
            <>
              ...
              {/* Buyer Protection Trust Box */}
              <div className="bg-green-50 border border-green-100 rounded-xl p-4 mt-4 flex gap-3">
                <svg className="w-5 h-5 text-primary shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                <div>
                  <p className="text-sm font-semibold text-gray-900 mb-0.5">Protected purchase</p>
                  <p className="text-xs text-gray-700 leading-relaxed">
                    Your payment is held securely. If the item is damaged, fake, wrong, or significantly different from the listing, you can report it within 48 hours of delivery.
                  </p>
                </div>
              </div>
